...
def get_stock_data(data_type, ticker, start, end):
    ...
    if data_type == 'stock_data':
        ...
        if start != five_years_earlier:
            stock_data = get_historical_data(ticker,start = '2018-01-01', end = pd.to_datetime(datetime.datetime.today()),token ='sk_6d1c2037a984473895a42a17710cf794', output_format = 'pandas')
